        ...
        <div style={{ background: '#fff', borderRadius: 24, padding: '36px', border: '1.5px solid #E8DCC8' }}>
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <select name="college" value={form.college} onChange={handleChange}
              style={{ width: '100%', border: '1.5px solid #E8DCC8', borderRadius: 12, padding: '12px 16px', fontFamily: 'Sora, sans-serif', fontSize: 14, outline: 'none', background: '#F5ECD8', color: '#1A0C00', boxSizing: 'border-box' }}>
